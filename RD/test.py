...
def cal_anomaly_map(fs_list, ft_list, out_size=224, amap_mode='mul'):
    '''
    :param fs_list: student的特征列表
    :param ft_list: teacher的特征列表
    :param out_size: the return size will determine the size after the features are bilinear upsampled
    :param amap_mode:
    :return: the sum of resized anomaly maps
    '''
    if amap_mode == 'mul':
    ...
    for i in range(len(ft_list)):
        ...
        a_map = 1 - F.cosine_similarity(fs, ft)  # 求单个特征的余弦相似度
